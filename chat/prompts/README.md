...
- **2. test_idea** — `invention_loop`
  - round_1
    ...
    - `2_gen_plan/` — 3 task(s)
      ...
      - `chat/prompts/2_test_idea/round_1/2_gen_plan/gen_plan_experiment_1.md` — 4 prompts
    ...
    - `3_gen_art/` — 3 task(s)
      ...
      - `chat/prompts/2_test_idea/round_1/3_gen_art/gen_art_experiment_1.md` — 14 prompts
  ...
  - round_2
    - `chat/prompts/2_test_idea/round_2/1_gen_strat.md` — 4 prompts
    - `2_gen_plan/` — 3 task(s)
    ...
    - `3_gen_art/` — 3 task(s)
      ...
      - `chat/prompts/2_test_idea/round_2/3_gen_art/gen_art_experiment_1.md` — 13 prompts
      - `chat/prompts/2_test_idea/round_2/3_gen_art/gen_art_research_1.md` — 7 prompts
