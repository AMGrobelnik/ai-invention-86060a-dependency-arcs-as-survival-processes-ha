...
- **1. create_idea** — `hypo_loop`
  - round_1
    - `chat/messages/1_create_idea/round_1/1_gen_hypo.md` — 43 messages
    - `chat/messages/1_create_idea/round_1/2_review_hypo.md` — 15 messages
- **2. test_idea** — `invention_loop`
  - round_1
    - `chat/messages/2_test_idea/round_1/1_gen_strat.md` — 13 messages
    - `2_gen_plan/` — 3 task(s)
      - `chat/messages/2_test_idea/round_1/2_gen_plan/gen_plan_dataset_1.md` — 56 messages
      - `chat/messages/2_test_idea/round_1/2_gen_plan/gen_plan_experiment_1.md` — 49 messages
      - `chat/messages/2_test_idea/round_1/2_gen_plan/gen_plan_research_1.md` — 70 messages
    - `3_gen_art/` — 3 task(s)
      - `chat/messages/2_test_idea/round_1/3_gen_art/gen_art_dataset_1.md` — 387 messages
      - `chat/messages/2_test_idea/round_1/3_gen_art/gen_art_experiment_1.md` — 186 messages
      - `chat/messages/2_test_idea/round_1/3_gen_art/gen_art_research_1.md` — 180 messages
    - `chat/messages/2_test_idea/round_1/4_gen_paper_text.md` — 71 messages
    - `chat/messages/2_test_idea/round_1/5_review_paper.md` — 13 messages
    - `chat/messages/2_test_idea/round_1/6_upd_hypo.md` — 10 messages
  - round_2
    - `chat/messages/2_test_idea/round_2/1_gen_strat.md` — 21 messages
    - `2_gen_plan/` — 3 task(s)
      - `chat/messages/2_test_idea/round_2/2_gen_plan/gen_plan_evaluation_1.md` — 23 messages
      - `chat/messages/2_test_idea/round_2/2_gen_plan/gen_plan_experiment_1.md` — 24 messages
      - `chat/messages/2_test_idea/round_2/2_gen_plan/gen_plan_research_1.md` — 44 messages
    - `3_gen_art/` — 3 task(s)
      - `chat/messages/2_test_idea/round_2/3_gen_art/gen_art_evaluation_1.md` — 134 messages
      - `chat/messages/2_test_idea/round_2/3_gen_art/gen_art_experiment_1.md` — 906 messages
      - `chat/messages/2_test_idea/round_2/3_gen_art/gen_art_research_1.md` — 151 messages
    - `chat/messages/2_test_idea/round_2/4_gen_paper_text.md` — 95 messages
...
- **3. report_results** — `gen_paper_repo`
  - `1_gen_viz/` — 3 task(s)
    ...
    - `chat/messages/3_report_results/1_gen_viz/gen_viz_2.md` — 72 messages
    - `chat/messages/3_report_results/1_gen_viz/gen_viz_3.md` — 22 messages
  - `2_gen_demo_art/` — 4 task(s)
    - `chat/messages/3_report_results/2_gen_demo_art/gen_demo_art_dataset_1.md` — 114 messages
    - `chat/messages/3_report_results/2_gen_demo_art/gen_demo_art_evaluation_1.md` — 62 messages
    - `chat/messages/3_report_results/2_gen_demo_art/gen_demo_art_experiment_1.md` — 63 messages
    - `chat/messages/3_report_results/2_gen_demo_art/gen_demo_art_experiment_2.md` — 65 messages
  - `chat/messages/3_report_results/3_gen_full_paper.md` — 116 messages
